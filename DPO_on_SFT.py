...
if __name__ == "__main__":
    ...
    # output_path = f"/scratch/user/chuanhsin0110/test_0321/output/{method_name}{run}/{sample_method}-{run_}"
    train_data_path = f"/scratch/user/chuanhsin0110/test_0321/output/{method_name}/{D}_{num_return_sequences}_{diversity_penalty}/{sample_method}/data/train.json"
    valid_data_path = f"/scratch/user/chuanhsin0110/test_0321/output/{method_name}/{D}_{num_return_sequences}_{diversity_penalty}/{sample_method}/data/valid.json"
